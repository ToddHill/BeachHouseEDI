...
function preSavePage(options) {
    ...
    if (subarray && subarray.length) {
        ...
        const LINdata = options.data[0].map((record, index) => {
            ...
            // Check if 'T' level for the current 'hierarchical3MaN' exists
            if (!hierarchicalLevels[record.hierarchical3MaN]) {
                ...
                hierarchicalLevels[record.hierarchical3MaN] = hierarchicalIDCounter.toString(); // Save 'T' level ID for this 'hierarchical3MaN'
            }
        ...
        // Your existing code after HL_loop section...
