...
///////////////////// ITEM BELOW THIS LINE /////////////////////////
///////////////////// ARE USED IN CELIGO ///////////////////////////
///////////////////// ENVIRONMENT //////////////////////////////////

/*
* Nordstrom Inbound 850 Orderful v3
* This script is used to parse an inbound 850 EDI file from Nordstrom and convert it into a format that can be used to create sales orders in NetSuite.
*
* version 3.0
* author: Todd Hill
* date: 2024-02-15
* Release Notes:
* - added support for multiple sales orders per transaction set
* - added support for multiple items per sales order
* - added support for multiple destination quantities per item
* - added support for multiple product service IDs per item
* - added support for multiple PID loops per item
* - added support for multiple dateTimeReference segments per transaction set
* - added support for multiple referenceInformation segments per transaction set
* - added support for multiple N1 loops per transaction set
* - added support for multiple PO1 loops per transaction set
* - added support for multiple REF loops per transaction set
* - added support for multiple DTM loops per transaction set
* - added support for multiple N1 loops per transaction set
* - added support for multiple N3 loops per transaction set
* - added support for multiple N4 loops per transaction set
* - added support for multiple PER loops per transaction set
* - added support for multiple TD5 loops per transaction set
*/
